...
Status = Redis:get(itsEssen.."Essen:PresidentQ:Group:Reply"..ChatId) or 'المالك'
...
msg.Name_Controller = Redis:get(itsEssen.."Essen:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(itsEssen..'Essen:Channel:Join')}, },}}
...
Redis:sadd(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,msg.sender.user_id) 
...
Redis:srem(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(itsEssen.."Essen:Name:Bot") or "Essen")..
