...
return {
Lock     = '[❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳](https://t.me/eilandSourCe)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n•︙خاصيه المسح *',
unLock   = '[❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳](https://t.me/eilandSourCe)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳](https://t.me/eilandSourCe)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n•︙خاصيه الكتم *',
lockKid  = '[❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳](https://t.me/eilandSourCe)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n•︙خاصيه التقييد *',
lockKick = '[❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳](https://t.me/eilandSourCe)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n•︙خاصيه الطرد *',
Reply    = '[❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳](https://t.me/eilandSourCe)\n*— — — — — — — — —\n•︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
elseif tonumber(msg.sender.user_id) == 2132412121 then
msg.Name_Controller = 'UPdaTeD '
msg.The_Controller = 1
...
Redis:incr(itsEssen.."Essen:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(itsEssen.."Essen:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(itsEssen.."Essen:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(itsEssen.."Essen:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
{
{text = '❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳', url='https://t.me/eilandSourCe'},
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*•︙اهلا بك مجددا عزيزي \n•︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس آيلاند فقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
Redis:set(itsEssen.."myphoto"..msg.chat_id,"true")
...
Get_Is_Id = Redis:get(itsEssen.."Essen:Set:Id:Group"..msg_chat_id)
...
if text and text:match('^بحث (.*)$') and Redis:get(itsEssen.."Essen:Status:yt"..msg.chat_id) then
...
{
{text = '❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/eilandSourCe"}
},
{
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/shaarEssen/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "ميمز" then
Abs = math.random(2,140); 
...
local UserId_Info = LuaTele.searchPublicChat("@VW4WV")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/eilandSourCe"}}
}
local msg_id = msg.id/2097152/0.5
...
local Text =[[
*•︙𝗐ᴇʟᴄᴏ𝗆𝖾 ᴛᴏ 𝗌𝗈𝗎𝗋𝖼𝖾 𝖾𝗂𝗅𝖺𝗇ᴅ .*
— — — — — — — — —
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❲ 𝖾𝗂𝗅𝖺𝗇ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="https://t.me/eilandSourCe"},{text = '❲ Updates source ❳',url="https://t.me/eiland_SourCe"}
},
{
{text = '❲ Group Problems Source ❳',url="https://t.me/Problemseiland"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/eilandSourCe&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
if text == (Redis:get(itsEssen.."Essen:Name:Bot") or "Essen") then
...
"الا تريد معرفه اخباري ؟ يمكنك قول كيف حالك او شلصحه",
}
...
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
...
local CmdStart = '*\n•︙welcome to Bot  '..(Redis:get(itsEssen.."Essen:Name:Bot") or "Essen")..
'\n•︙The competence of the bot to protect groups .'..
'\n•︙To activate the bot you have to follow the following .'..
'\n•︙Add bot to your collection .'..
'\n•︙Lift it admin.'..
'\n•︙Send the word { activate } to activate the group .'..
'\n•︙developer Bot | <@'..UserSudo..'>*'
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '❲ 𝖾𝗂𝗅𝖺??ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/eilandSourCe"}
},
}
local msg_id = Msg_id/2097152/0.5
...
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
