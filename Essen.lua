...
local itsEssen = io.open("itsEssen", 'w')
itsEssen:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Essen.lua
done
]])
itsEssen:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S itsEssen -X kill
screen -S itsEssen ./itsEssen
done
]])
Run:close()
...
os.execute('chmod +x itsEssen;chmod +x Run;./Run')
end
...
itsEssen = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..itsEssen)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=itsEssen,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",UserId) 
if UserId == 2042257789 then
Status = true
elseif UserId == 1369608701 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == itsEssen then
Status = true
...
Status = 0
Developers = Redis:sismember(itsEssen.."Essen:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",UserId) 
TheBasicsQ = Redis:sismember(itsEssen.."Essen:TheBasicsQ:Group"..ChatId,UserId) 
TheBasics = Redis:sismember(itsEssen.."Essen:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(itsEssen.."Essen:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(itsEssen.."Essen:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(itsEssen.."Essen:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(itsEssen.."Essen:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(itsEssen.."Essen:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = "المالك"
elseif TheBasics then
Status = Redis:get(itsEssen.."Essen:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(itsEssen.."Essen:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(itsEssen.."Essen:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(itsEssen.."Essen:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(itsEssen.."Essen:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(itsEssen.."Essen:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(itsEssen.."Essen:lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❌"    
end
if Redis:get(itsEssen.."Essen:Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❌"
end
if Redis:get(itsEssen.."Essen:Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❎"    
end    
if Redis:get(itsEssen.."Essen:Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❎"    
end    
if Redis:get(itsEssen.."Essen:Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❎"    
end
if Redis:get(itsEssen.."Essen:Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❎"    
end
if Redis:hget(itsEssen.."Essen:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(itsEssen.."Essen:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(itsEssen.."Essen:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(itsEssen.."Essen:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❎"     
end
if Redis:get(itsEssen.."Essen:Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(itsEssen.."Essen:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(itsEssen.."Essen:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❎"   
end    
if Redis:get(itsEssen.."Essen:Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(itsEssen.."Essen:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❎"    
end    
if Redis:get(itsEssen.."Essen:Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(itsEssen.."Essen:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❎"    
end 
if Redis:get(itsEssen.."Essen:Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❎"    
end    
...
if Redis:get(itsEssen.."Essen:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(itsEssen.."Essen:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❎"
end
if Redis:get(itsEssen.."Essen:Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❎"    
end    
if Redis:get(itsEssen.."Essen:Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❎"    
end    
if Redis:get(itsEssen.."Essen:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(itsEssen.."Essen:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❎"    
end
if Redis:get(itsEssen.."Essen:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(itsEssen.."Essen:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(itsEssen.."Essen:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(itsEssen.."Essen:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❎"    
end        
...
return{
BanAll = Redis:sismember(itsEssen.."Essen:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(itsEssen.."Essen:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(itsEssen.."Essen:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,itsEssen).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(itsEssen..'Essen:Channel:Join')
if Channel then
...
Redis:incr(itsEssen..'Essen:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(itsEssen) then
...
elseif tonumber(msg.sender.user_id) == 1369608701 then
msg.Name_Controller = 'مطور السورس'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'مطور اساسي ²'
elseif Redis:sismember(itsEssen.."Essen:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(itsEssen.."Essen:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(itsEssen.."Essen:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = "المالك"
elseif Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(itsEssen.."Essen:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(itsEssen.."Essen:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(itsEssen.."Essen:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(itsEssen.."Essen:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(itsEssen.."Essen:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(itsEssen.."Essen:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(itsEssen.."Essen:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(itsEssen) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(itsEssen.."Essen:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(itsEssen.."Essen:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(itsEssen.."Essen:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(itsEssen.."Essen:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(itsEssen.."Essen:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(itsEssen) then
return false
end
local floods = Redis:hget(itsEssen.."Essen:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(itsEssen.."Essen:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(itsEssen.."Essen:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(itsEssen.."Essen:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(itsEssen.."Essen:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(itsEssen.."Essen:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(itsEssen.."Essen:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(itsEssen.."Essen:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(itsEssen.."Essen:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(itsEssen..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(itsEssen..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
sens = 400  
if Redis:get(itsEssen.."Essen:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(itsEssen.."Essen:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(itsEssen.."Essen:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(itsEssen.."Essen:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(itsEssen.."Essen:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Originators then -- التوجيه
local Fwd_Group = Redis:get(itsEssen.."Essen:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(itsEssen.."Essen:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(itsEssen.."Essen:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(itsEssen.."Essen:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(itsEssen.."Essen:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(itsEssen.."Essen:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(itsEssen.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(itsEssen.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(itsEssen.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(itsEssen) then
local N = (Redis:get(itsEssen.."Name:Bot") or "باڤ")
photo = LuaTele.getUserProfilePhotos(itsEssen)
...
Redis:set(itsEssen.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(itsEssen.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(itsEssen.."Essen:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(itsEssen.."Essen:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(itsEssen.."Essen:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(itsEssen.."Essen:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(itsEssen.."Essen:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(itsEssen.."Essen:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(itsEssen.."Essen:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(itsEssen.."Essen:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(itsEssen.."Essen:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(itsEssen.."Essen:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(itsEssen.."Essen:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(itsEssen.."Essen:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(itsEssen.."Essen:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(itsEssen.."Essen:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(itsEssen.."Essen:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(itsEssen.."Essen:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(itsEssen..'Essen:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(itsEssen.."Essen:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(itsEssen.."Essen:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(itsEssen.."Essen:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(itsEssen.."Essen:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(itsEssen.."Essen:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(itsEssen.."Essen:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(itsEssen.."Essen:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(itsEssen.."Essen:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(itsEssen..'Essen:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(itsEssen..'Essen:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(itsEssen.."Essen:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(itsEssen.."Essen:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(itsEssen.."Essen:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(itsEssen..'Essen:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(itsEssen..'Essen:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(itsEssen.."Essen:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(itsEssen.."Essen:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(itsEssen.."Essen:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(itsEssen.."Essen:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(itsEssen.."Essen:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(itsEssen.."Essen:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(itsEssen.."Essen:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(itsEssen.."Essen:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(itsEssen..'Essen:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(itsEssen.."Essen:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(itsEssen.."Essen:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(itsEssen.."Essen:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(itsEssen.."Essen:Command:List:Group"..msg_chat_id,text)
...
Redis:del(itsEssen.."Essen:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(itsEssen.."Essen:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(itsEssen.."Essen:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(itsEssen.."Essen:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(itsEssen.."Essen:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(itsEssen.."Essen:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(itsEssen.."Essen:Command:Reids:Group:New"..msg_chat_id)
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(itsEssen.."Essen:Command:List:Group"..msg_chat_id,text)
Redis:del(itsEssen.."Essen:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(itsEssen.."Essen:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(itsEssen.."Essen:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(itsEssen.."Essen:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(itsEssen.."Essen:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(itsEssen.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(itsEssen.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(itsEssen.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(itsEssen.."Essen:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(itsEssen.."Essen:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(itsEssen.."Essen:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(itsEssen.."Essen:Group:Rules" .. msg_chat_id,text) 
Redis:del(itsEssen.."Essen:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(itsEssen.."Essen:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(itsEssen.."Essen:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(itsEssen.."Essen:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(itsEssen.."Essen:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(itsEssen.."Essen:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم حفظ رد للمدير بنجاح \n˛ : ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(itsEssen.."Essen:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(itsEssen.."Essen:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(itsEssen.."Essen:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(itsEssen.."Essen:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(itsEssen.."Essen:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(itsEssen.."Essen:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '˛ 𝗍𝖾𝖺𝗆 𝗉𝖺𝗏 .', url='https://t.me/teampav'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(itsEssen.."Essen:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(itsEssen.."Essen:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(itsEssen.."Essen:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(itsEssen.."Essen:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(itsEssen.."Essen:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(itsEssen.."Essen:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(itsEssen.."Essen:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Video"..text)
local document = Redis:get(itsEssen.."Essen:Add:Rd:Sudo:File"..text)
local audio = Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(itsEssen.."Essen:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(itsEssen..'Essen:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(itsEssen..'Essen:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(itsEssen.."Essen:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(itsEssen.."Essen:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(itsEssen.."Essen:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(itsEssen.."Essen:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(itsEssen.."Essen:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(itsEssen.."Essen:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(itsEssen.."Essen:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(itsEssen.."Essen:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(itsEssen.."Essen:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(itsEssen.."Essen:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(itsEssen..'Essen:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(itsEssen.."Essen:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(itsEssen.."Essen:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(itsEssen.."Essen:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(itsEssen.."Essen:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(itsEssen.."Essen:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(itsEssen.."Essen:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsEssen.."Essen:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(itsEssen.."Essen:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(itsEssen.."Essen:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(itsEssen.."Essen:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(itsEssen.."Essen:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(itsEssen.."Essen:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(itsEssen.."Essen:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(itsEssen.."Essen:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(itsEssen.."Essen:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(itsEssen.."Essen:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(itsEssen.."Essen:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(itsEssen..'Essen:'..v..text)
end
Redis:del(itsEssen.."Essen:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(itsEssen.."Essen:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(itsEssen.."Essen:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(itsEssen.."Essen:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n˛ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(itsEssen.."Essen:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(itsEssen.."Essen:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(itsEssen.."Essen:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(itsEssen.."Essen:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(itsEssen.."Essen:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(itsEssen.."Essen:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(itsEssen.."Essen:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(itsEssen.."Essen:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(itsEssen.."Essen:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(itsEssen.."Essen:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(itsEssen.."Essen:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(itsEssen.."Essen:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n˛ : تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(itsEssen..'Essen:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(itsEssen.."Essen:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(itsEssen.."Essen:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n˛ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(itsEssen.."Essen:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(itsEssen.."Essen:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(itsEssen.."Essen:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(itsEssen.."Essen:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(itsEssen.."Essen:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(itsEssen..'Essen:GetTexting:DevitsEssen'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(itsEssen..'Essen:GetTexting:DevitsEssen'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'˛ : تم الغاء حفظ كليشة المطور')
end
Redis:set(itsEssen..'Essen:Texting:DevitsEssen',text)
Redis:del(itsEssen..'Essen:GetTexting:DevitsEssen'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'˛ : تم حفظ كليشة المطور')
end
if Redis:get(itsEssen.."Essen:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n˛ : تم الغاء امر تعين الايدي","md",true)  
Redis:del(itsEssen.."Essen:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(itsEssen.."Essen:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(itsEssen.."Essen:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(itsEssen.."Essen:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(itsEssen.."Essen:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n˛ : تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(itsEssen.."Essen:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(itsEssen.."Essen:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "˛ : تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(itsEssen.."Essen:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(itsEssen.."Essen:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(itsEssen.."Essen:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(itsEssen.."Essen:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم تعين الايدي عام',"md",true)  
end
if Redis:get(itsEssen.."Essen:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(itsEssen.."Essen:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n˛ : تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(itsEssen.."Essen:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(itsEssen.."Essen:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "˛ : تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(itsEssen.."Essen:Game:Smile"..msg.chat_id) then
if text == Redis:get(itsEssen.."Essen:Game:Smile"..msg.chat_id) then
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(itsEssen.."Essen:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : لقد فزت في اللعبه \n˛ : اللعب مره اخره وارسل - سمايل او سمايلات","md",true)
end
end 
if Redis:get(itsEssen.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(itsEssen.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(itsEssen.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(itsEssen.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : لقد فزت في اللعبه \n˛ : العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(itsEssen.."mshaher"..msg.chat_id) then
if text == Redis:get(itsEssen.."mshaher"..msg.chat_id) then
Redis:del(itsEssen.."mshaher"..msg.chat_id)
Redis:incrby(itsEssen.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : لقد فزت في اللعبه \n˛ : العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end
if Redis:get(itsEssen.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(itsEssen.."Game:enkliz"..msg.chat_id) then
Redis:incrby(itsEssen.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(itsEssen.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : لقد فزت في اللعبه \n˛ : العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(itsEssen.."Essen:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(itsEssen.."Essen:Game:Monotonous"..msg.chat_id) then
Redis:del(itsEssen.."Essen:Game:Monotonous"..msg.chat_id)
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : لقد فزت في اللعبه \n˛ : اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(itsEssen.."Essen:Game:Riddles"..msg.chat_id) then
if text == Redis:get(itsEssen.."Essen:Game:Riddles"..msg.chat_id) then
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(itsEssen.."Essen:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : لقد فزت في اللعبه \n˛ : اللعب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(itsEssen.."Essen:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(itsEssen.."Essen:Game:Meaningof"..msg.chat_id) then
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(itsEssen.."Essen:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : لقد فزت في اللعبه \n˛ : اللعب مره اخره وارسل - معاني","md",true)   
end
end
if Redis:get(itsEssen.."Essen:Game:Reflection"..msg.chat_id) then
if text == Redis:get(itsEssen.."Essen:Game:Reflection"..msg.chat_id) then
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(itsEssen.."Essen:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : لقد فزت في اللعبه \n˛ : اللعب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(itsEssen.."Essen:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(itsEssen.."Essen:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(itsEssen.."Essen:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(itsEssen.."Essen:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(itsEssen.."Essen:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(itsEssen.."Essen:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(itsEssen.."Essen:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(itsEssen.."Essen:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(itsEssen.."Essen:Game:Difference"..msg.chat_id) then
if text == Redis:get(itsEssen.."Essen:Game:Difference"..msg.chat_id) then 
Redis:del(itsEssen.."Essen:Game:Difference"..msg.chat_id)
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(itsEssen.."Essen:Game:Example"..msg.chat_id) then
if text == Redis:get(itsEssen.."Essen:Game:Example"..msg.chat_id) then 
Redis:del(itsEssen.."Essen:Game:Example"..msg.chat_id)
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if tonumber(itsEssen) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'˛ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(itsEssen..'Essen:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(itsEssen.."Essen:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(itsEssen.."Essen:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(itsEssen.."Essen:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(itsEssen.."Essen:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(itsEssen.."Essen:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(itsEssen.."Essen:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(itsEssen) then 
return LuaTele.sendText(msg_chat_id,msg_id,'˛ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(itsEssen.."Essen:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(itsEssen.."Essen:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(itsEssen.."Essen:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(itsEssen.."Essen:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(itsEssen.."Essen:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(itsEssen..'Essen:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(itsEssen..'Essen:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,itsEssen).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n˛ : البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(itsEssen..'Essen:Channel:Join',ChannelUser) 
Redis:set(itsEssen..'Essen:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(itsEssen..'Essen:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(itsEssen..'Essen:Channel:Join')
...
--download('https://raw.githubusercontent.com/SourceitsEssen/itsEssen/master/Essen.lua','Essen.lua')
...
local Groups = Redis:smembers(itsEssen..'Essen:ChekBotAdd')  
local UsersBot = Redis:smembers(itsEssen..'Essen:Num:User:Pv')  
local Get_Json = '{"BotId": '..itsEssen..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(itsEssen.."Essen:TheBasics:Group"..v)
local Constructor = Redis:smembers(itsEssen.."Essen:Originators:Group"..v)
local Manager = Redis:smembers(itsEssen.."Essen:Managers:Group"..v)
local Admin = Redis:smembers(itsEssen.."Essen:Addictive:Group"..v)
local Vips = Redis:smembers(itsEssen.."Essen:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(itsEssen.."Essen:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(itsEssen.."Essen:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(itsEssen.."Essen:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(itsEssen.."Essen:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(itsEssen.."Essen:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(itsEssen.."Essen:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(itsEssen.."Essen:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(itsEssen.."Essen:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(itsEssen.."Essen:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(itsEssen.."Essen:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(itsEssen.."Essen:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
Get_Json = Get_Json..'"'..v..'":"'..db..'",'
end   
Get_Json = Get_Json..'"TttttX":"ok"'
end
Get_Json = Get_Json..'}'
end
Get_Json = Get_Json..'}}'
...
if ListGroup.TttttX == "ok" then
for k,v in pairs(ListGroup) do
Redis:sadd(itsEssen.."Essen:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(itsEssen.."Essen:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(itsEssen..'Essen:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(itsEssen)
local UserInfo = LuaTele.getUser(itsEssen)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(itsEssen.."Essen:Name:Bot") or "باڤ")
Groups = (Redis:scard(itsEssen..'Essen:ChekBotAdd') or 0)
Users = (Redis:scard(itsEssen..'Essen:Num:User:Pv') or 0)
...
local NumAdd = Redis:get(itsEssen.."Essen:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
if Redis:sismember(itsEssen.."Essen:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(itsEssen..'Essen:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'˛ : عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(itsEssen..'Essen:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
Redis:sadd(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,msg.sender.user_id) 
Redis:sadd(itsEssen.."Essen:ChekBotAdd",msg_chat_id)
Redis:set(itsEssen.."Essen:Status:Id"..msg_chat_id,true) ;Redis:set(itsEssen.."Essen:Status:Reply"..msg_chat_id,true) ;Redis:set(itsEssen.."Essen:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(itsEssen.."Essen:Status:BanId"..msg_chat_id,true) ;Redis:set(itsEssen.."Essen:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(itsEssen.."Essen:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(itsEssen.."Essen:ChekBotAdd",msg_chat_id) then
...
Redis:srem(itsEssen.."Essen:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(itsEssen.."Essen:ChekBotAdd",msg_chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*˛ : اهلا بك مجددا عزيزي \n˛ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس باڤ فقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
Redis:set(itsEssen.."lockalllll"..msg_chat_id,"off")
...
Redis:set(itsEssen.."lockalllll"..msg_chat_id,"on")
...
if Redis:get(itsEssen.."lockalllll"..msg_chat_id) == "on" then
if not msg.Addictive then
...
Redis:del(itsEssen..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n˛ : تم تعطيل المتحركه'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(itsEssen..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(itsEssen..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n˛ : تم تفعيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(itsEssen..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n˛ : تم تعطيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(itsEssen..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(itsEssen..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n˛ : تم تفعيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(itsEssen..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n˛ : تم تعطيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(itsEssen..'Abs:Remix:Abs'..msg.chat_id,true)  
end
...
local F333F = ' \n˛ : تم تفعيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(itsEssen..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n˛ : تم تعطيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(itsEssen..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(itsEssen..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n˛ : تم تفعيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(itsEssen..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n˛ : تم تعطيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(itsEssen..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(itsEssen..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n˛ : تم تفعيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(itsEssen..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n˛ : تم تعطيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(itsEssen..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(itsEssen..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n˛ : تم تفعيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(itsEssen..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n˛ : تم تعطيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(itsEssen..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(itsEssen..'Abs:Series:Abs'..msg.chat_id) then
...
if text == 'بايو' and not Redis:get(itsEssen..'idnotmembio'..msg.chat_id)  then
...
if Redis:get(itsEssen..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '˛ : تم تعطيل امر البايو مسبقا\n ✓',"md")
else
Redis:set(itsEssen.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(itsEssen..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '˛ : تم تفعيل امر البايو مسبقا\n ✓',"md")
else
Redis:del(itsEssen.."idnotmembio"..msg.chat_id)
...
if Redis:get(itsEssen..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(itsEssen..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(itsEssen..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '˛ : اليك النتائج الخـاصة :\n\n˛ : نسبة الغباء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(itsEssen..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(itsEssen..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '˛ : اليك النتائج الخـاصة :\n\n˛ : نسبة الذكاء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(itsEssen..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(itsEssen..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌯ اليك النتائج الخـاصة :\n\n⌯ نسبه الكرة : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(itsEssen..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(itsEssen..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '˛ : اليك النتائج الخـاصة :\n\n˛ : نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(itsEssen..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(itsEssen..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '˛ : اليك النتائج الخـاصة :\n\n˛ : نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(itsEssen..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end

if text == "نسبه الحب" or text == "نسبه حب" and msg.reply_to_message_id ~= 0 then
if not Redis:get(itsEssen.."AlNsb"..msg.chat_id) then    
Redis:set(itsEssen..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(itsEssen.."AlNsb"..msg.chat_id) then    
Redis:set(itsEssen..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(itsEssen.."AlNsb"..msg.chat_id) then    
Redis:set(itsEssen..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '˛ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(itsEssen.."AlNsb"..msg.chat_id) then    
Redis:set(itsEssen..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '˛ : الان ارسل اسمك واسم الشخص الثاني :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(itsEssen.."AlNsb"..msg.chat_id) then    
Redis:set(itsEssen..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '˛ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(itsEssen.."AlNsb"..msg.chat_id) then    
Redis:set(itsEssen..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '˛ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if Redis:get(itsEssen..'AlNsb'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'˛ : تم تعطيل النسب مسبقا\n ✓',"md")
else
Redis:set(itsEssen.."AlNsb"..msg.chat_id,"true")
...
Redis:del(itsEssen.."AlNsb"..msg.chat_id)
...
if Redis:get(itsEssen..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'˛ : تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(itsEssen.."myphoto"..msg.chat_id,"off")
...
if not Redis:get(itsEssen..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'˛ : تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(itsEssen.."myphoto"..msg.chat_id)
...
Redis:del(itsEssen.."mybuti"..msg_chat_id)
...
Redis:set(itsEssen.."mybuti"..msg_chat_id,"off")
...
Redis:del(itsEssen.."sayy"..msg_chat_id)
...
Redis:set(itsEssen.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*˛ : تم امر امر كول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(itsEssen.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(itsEssen.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(itsEssen.."myphoto"..msg_chat_id) == "off" then
...
Redis:set(itsEssen.."Essen:Set:Id:Group"..msg.chat_id,Text_Rand)
...
if not Redis:get(itsEssen.."Essen:Status:Id"..msg_chat_id) then
return false
end
local InfoUser = LuaTele.getUserFullInfo(msg.sender.user_id)
if InfoUser.bio then
...
local TotalMsg = Redis:get(itsEssen..'Essen:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(itsEssen..'Essen:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(itsEssen.."Essen:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {
'صورتك فدشي خيالي',
"شتحس مخلي هلصورا ؟ ",
"محتحت اقسم",
...
Get_Is_Id = Redis:get(itsEssen.."Essen:Set:Id:Groups") or Redis:get(itsEssen.."Essen:Set:Id:Group"..msg_chat_id)
if Redis:get(itsEssen.."Essen:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local TotalMsg = Redis:get(itsEssen..'Essen:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(itsEssen..'Essen:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*˛ : ايديه : '..UserId..
...
local TotalMsg = Redis:get(itsEssen..'Essen:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(itsEssen..'Essen:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*˛ : ايديه : '..UserId..
'\n˛ : معرفه : @'..UserName..
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(itsEssen.."Essen:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,itsEssen).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'˛ : البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,itsEssen).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✅ ❭' else change_info = '❬ ❎❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(itsEssen.."Essen:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(itsEssen.."Essen:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(itsEssen.."Essen:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."Essen:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."Essen:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."Essen:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."Essen:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : الحمار هاذا بطل يصفن ").Reply,"md",true)  
else
Redis:srem(itsEssen.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(itsEssen.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "ملك" then
if not Redis:sismember(itsEssen.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(itsEssen.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(itsEssen.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"˛ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(itsEssen.."Essen:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"˛ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Developers:Groups",UserId) 
...
if not Redis:sismember(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:TheBasicsW:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(itsEssen.."Essen:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(itsEssen.."Essen:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم ترقيته مطوࢪ بنجاح ✓ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(itsEssen.."Essen:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم ترقيته مطوࢪ بالفعل ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم ترقيته منشئ اساسي بالفعل ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(itsEssen.."Essen:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم ترقيته منشئ بالفعل ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(itsEssen.."Essen:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم ترقيته مدير بالفعل   ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(itsEssen.."Essen:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم ترقيته ادمن بالفعل   ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم ترقيته مميز بالفعل   ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."Essen:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."Essen:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم ترقيته مطوࢪ بالفعل ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ˛ : تم ترقيته منشئ اساسي •").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم ترقيته منشئ اساسي •").Reply,"md",true)  
end
end
if TextMsg == "منشئ" then
...
if Redis:sismember(itsEssen.."Essen:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم ترقيته منشئ بالفعل ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."Essen:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم ترقيته مدير بالفعل   ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم ترقيته ادمن بالفعل   ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم ترقيته ادمن • ").Reply,"md",true)  
end
end
if TextMsg == "كانسر" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(itsEssen.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(itsEssen..'Essen:Channel:Join:Name')..'', url = 't.me/'..Redis:get(itsEssen..'Essen:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n˛ : عَزيزي أشترك ثم أستخدم الأمر مرة أخرى .*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(itsEssen.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم ترقيته مميز بالفعل   ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"˛ : تم ترقيته مطوࢪ بنجاح ✓ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(itsEssen.."Essen:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"˛ : تم ترقيته مطوࢪ بالفعل ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Developers:Groups",UserId) 
...
if Redis:sismember(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم ترقيته منشئ اساسي بالفعل ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(itsEssen.."Essen:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم ترقيته منشئ بالفعل ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(itsEssen.."Essen:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم ترقيته مدير بالفعل   ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم ترقيته ادمن بالفعل   ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"˛ : تم ترقيته مميز بالفعل   ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(itsEssen.."Essen:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(itsEssen.."Essen:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(itsEssen.."Essen:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(itsEssen.."Essen:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(itsEssen.."Essen:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(itsEssen.."Essen:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(itsEssen.."Essen:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(itsEssen.."Essen:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*˛ : قائمه مطورين البوت \n  — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."Essen:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : لا يوجد منشئين اساسيين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(itsEssen.."Essen:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."Essen:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."Essen:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."Essen:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."Essen:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."Essen:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(itsEssen.."Essen:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(itsEssen.."Essen:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(itsEssen.."Essen:Status:Id"..msg_chat_id,true) 
...
Redis:set(itsEssen.."Essen:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(itsEssen.."Essen:Status:Reply"..msg_chat_id,true) 
...
Redis:set(itsEssen.."Essen:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(itsEssen.."Essen:Status:BanId"..msg_chat_id,true) 
...
Redis:set(itsEssen.."Essen:BotFree",true) 
...
Redis:set(itsEssen.."Essen:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(itsEssen.."Essen1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(itsEssen.."Essen1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(itsEssen.."Essen1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(itsEssen.."Essen1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(itsEssen.."Essen1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(itsEssen..'Essen1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(itsEssen..'Essen1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(itsEssen..'Essen1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(itsEssen.."Essen1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(itsEssen.."Essen1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(itsEssen.."Essen1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(itsEssen.."Essen1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(itsEssen.."Essen1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(itsEssen.."Essen1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(itsEssen.."Essen1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(itsEssen.."Essen1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(itsEssen.."Essen1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(itsEssen.."Essen1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsEssen.."Essen1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(itsEssen.."Essen1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsEssen.."Essen1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(itsEssen.."Essen1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsEssen.."Essen1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(itsEssen.."Essen1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsEssen.."Essen1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(itsEssen.."Essen1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsEssen.."Essen1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(itsEssen.."Essen1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsEssen.."Essen1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(itsEssen.."Essen1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(itsEssen.."Essen1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(itsEssen.."Essen1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(itsEssen.."Essen11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(itsEssen.."Essen11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(itsEssen.."Essen11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(itsEssen.."Essen11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(itsEssen.."Essen11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(itsEssen..'Essen11:Add:Rd:Sudo:Text'..text)
Redis:del(itsEssen..'Essen11:Add:Rd:Sudo:Text1'..text)
Redis:del(itsEssen..'Essen11:Add:Rd:Sudo:Text2'..text)
Redis:del(itsEssen.."Essen11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(itsEssen.."Essen11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(itsEssen.."Essen11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(itsEssen.."Essen11:Add:Rd:Sudo:Text"..v) 
Redis:del(itsEssen.."Essen11:Add:Rd:Sudo:Text1"..v) 
Redis:del(itsEssen.."Essen11:Add:Rd:Sudo:Text2"..v)   
Redis:del(itsEssen.."Essen11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(itsEssen.."Essen11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(itsEssen.."Essen11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(itsEssen.."Essen11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsEssen.."Essen11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(itsEssen.."Essen11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsEssen.."Essen11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(itsEssen.."Essen11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsEssen.."Essen11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(itsEssen.."Essen11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsEssen.."Essen11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(itsEssen.."Essen11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsEssen.."Essen11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(itsEssen.."Essen11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsEssen.."Essen11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(itsEssen.."Essen11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(itsEssen.."Essen11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(itsEssen.."Essen11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(itsEssen.."Essen:allM"..msg.chat_id, msg.id)
if Redis:get(itsEssen.."Essen:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(itsEssen.."Essen:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(itsEssen.."Essen:allM"..msg.chat_id)
...
Redis:del(itsEssen.."Essen:allM"..msg.chat_id)
end
end
end
if Redis:get(itsEssen.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
if Redis:get(itsEssen.."Essen:calculate"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '⌔︙تم تعطيل امر حساب العمر مسبقا\n ✓',"md")
else
Redis:set(itsEssen.."Essen:calculate"..msg.chat_id,"true")
LuaTele.sendText(msg_chat_id,msg_id, '⌔︙تم تعطيل حساب العمر \n ✓',"md")
end
end
if text == "تفعيل حساب العمر" then
if not Redis:get(itsEssen.."Essen:calculate"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '⌔︙تم تفعيل امر حساب العمر مسبقا\n ✓',"md")
else
Redis:del(itsEssen.."Essen:calculate"..msg.chat_id)
LuaTele.sendText(msg_chat_id,msg_id, '⌔︙تم تفعيل امر حساب العمر\n ✓',"md")
end
end
if text and text:match("^احسب (.*)$") and not Redis:get(itsEssen.."Essen:calculate"..msg.chat_id) then
...
local list = Redis:smembers(itsEssen.."Essen:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(itsEssen.."Essen:allM"..msg.chat_id)  
...
Redis:del(itsEssen.."Essen:Status:Del:Media"..msg.chat_id)
...
Redis:set(itsEssen.."Essen:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(itsEssen.."Essen:Status:yt"..msg.chat_id)
...
Redis:set(itsEssen.."Essen:Status:yt"..msg.chat_id,true)
...
local httpsCurl = "http://185.185.127.158/Essen/tahaj200.php?token="..Token.."&msg="..MsgId.."&Text="..URL.escape(Ttext).."&chat_id="..msg.chat_id.."&user="..msg.sender.user_id
...
local UserId_Info = LuaTele.searchPublicChat("TttttX")
...
if photo.total_count > 0 then
local TestText = "  ˛ 𝗍𝖾𝖺𝗆 𝗉𝖺𝗏 .\n — — — — — — — — —\n ˛ : *Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n˛ : *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/TttttX"}
},
{
{text = '˛ 𝗍𝖾𝖺𝗆 𝗉𝖺𝗏 .', url='https://t.me/teampav'},
},
...
local UserId_Info = LuaTele.searchPublicChat("YYYdY")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = '❲ مطور السورس ❳', url = "https://t.me/YYYdY"}
},
{
{text = '˛ 𝗍𝖾𝖺𝗆 𝗉𝖺𝗏 .', url='https://t.me/teampav'},
},
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Essenchat',url="https://accounts.Essenchat.com/accounts/login?continue=https%3A%2F%2Faccounts.Essenchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '˛ 𝗍𝖾𝖺𝗆 𝗉𝖺𝗏 .',url="t.me/teampav"}}
}
local msg_id = msg.id/2097152/0.5
...
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(itsEssen) then
    return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يحيحان ملكقتش غيري","md",true)  
  end
  if Redis:sismember(itsEssen..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    local rd_mtzwga = {
    ...
    if Redis:sismember(itsEssen..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(itsEssen..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(itsEssen..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(itsEssen..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(itsEssen..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(itsEssen..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(itsEssen..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
    local rd_tmtlaq = {
      "تم طلاقكم للاسف",
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(itsEssen..msg_chat_id.."mutlqat:")
...
local Text =[[
*˛ 𝗁𝖾𝗅𝗅𝗈 𝗉𝖾𝗈𝗉𝗅𝖾 𝗆𝖾 𝗍𝖾𝖺𝗆 𝗉𝖺𝗏 .
˛ 𝗂𝗍'𝗌 𝗌𝗈𝗎𝗋𝖼𝖾 𝖽𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 𝗈𝗇𝗅ʏ .*
 — — — — — — — — —
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '< Source Channel >',url="https://t.me/teampav"}},
{{text = '< Channel : Bots |',url="t.me/MoHaBoTs"},
{text = '| Tws teams >',url="https://t.me/iE1BOT"}},
{
{text = '< Bot Maker > ',url="https://t.me/vw1bot"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/teampav&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{
{text = '❲ VIP version updates ❳', url = "https://https://t.me/Essen_Source"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
Redis:del(itsEssen.."Essen:Status:joinet"..msg_chat_id) 
...
Redis:set(itsEssen.."Essen:Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(itsEssen.."Essen:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(itsEssen.."Essen:Status:Welcome"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Status:Id"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Status:Reply"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Status:BanId"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(itsEssen.."Essen:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(itsEssen.."Essen:Status:KickMe"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:BotFree") 
...
Redis:del(itsEssen.."Essen:TwaslBot") 
...
if Redis:sismember(itsEssen.."Essen:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(itsEssen.."Essen:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(itsEssen.."Essen:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(itsEssen.."Essen:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(itsEssen.."Essen:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˛ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(itsEssen.."Essen:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."Essen:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."Essen:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˛ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"˛ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"˛ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"˛ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
Rink = 1
elseif Redis:sismember(itsEssen.."Essen:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(itsEssen.."Essen:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(itsEssen.."Essen:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(itsEssen.."Essen:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(itsEssen.."Essen:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(itsEssen.."Essen:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ◉ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end
if text == "اطردني" or text == "طردني" then
if not Redis:get(itsEssen.."Essen:Status:KickMe"..msg_chat_id) then
...
Redis:sadd(itsEssen.."Essen:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(itsEssen.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(itsEssen.."Lock:channell"..msg_chat_id)  
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(itsEssen..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n˛ : عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:del(itsEssen.."Essen:LeftBot") 
...
Redis:set(itsEssen.."Essen:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(itsEssen.."Essen:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '/offConvert@Uy2bot' then   
Redis:del(itsEssen.."Essen:AddSudosNew"..msg_chat_id)
...
if not msg.ControllerBot and not Redis:set(itsEssen.."Essen:LeftBot") then
...
Redis:set(itsEssen.."Essen:Lock:text"..msg_chat_id,true) 
...
Redis:set(itsEssen.."Essen:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(itsEssen.."Essen:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(itsEssen.."Essen:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(itsEssen.."Essen:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(itsEssen.."Essen:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(itsEssen.."Essen:Lock:edit"..msg_chat_id,true) 
...
Redis:set(itsEssen.."Essen:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(itsEssen..'Essen:'..lock..msg_chat_id,"del")    
end
...
Redis:del(itsEssen.."Essen:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(itsEssen.."Essen:Lock:text"..msg_chat_id)  
...
Redis:del(itsEssen.."Essen:Lock:Join"..msg_chat_id)  
...
Redis:del(itsEssen.."Essen:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(itsEssen.."Essen:Lock:tagservr"..msg_chat_id)  
...
Redis:del(itsEssen.."Essen:lockpin"..msg_chat_id)  
...
Redis:del(itsEssen.."Essen:Lock:edit"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(itsEssen..'Essen:'..lock..msg_chat_id)    
end
...
Redis:hset(itsEssen.."Essen:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(itsEssen.."Essen:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(itsEssen.."Essen:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(itsEssen.."Essen:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(itsEssen.."Essen:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(itsEssen.."Essen:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Link"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:User:Name"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:hashtak"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Cmd"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:set(itsEssen.."Essen:Lock:phshar"..msg_chat_id,true) 
...
Redis:set(itsEssen..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(itsEssen.."Essen:Lock:phshar"..msg_chat_id)  
...
Redis:del(itsEssen..'lock:Fars'..msg.chat_id) 
...
Redis:del(itsEssen.."Essen:Lock:Photo"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Video"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Animation"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:geam"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Audio"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:vico"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Sticker"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:forward"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Document"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Contact"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Spam"..msg_chat_id)  
...
Redis:set(itsEssen.."Essen:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(itsEssen.."Essen:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(itsEssen.."Essen:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(itsEssen.."Essen:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(itsEssen.."Essen:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(itsEssen.."Essen:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(itsEssen.."Essen:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم مسح الرابط ","md",true)             
end
if text == "رابط." then
if not Redis:get(itsEssen.."Essen:Status:Link"..msg_chat_id) then
...
local LinkGroup = LuaTele.generateChatInviteLink(msg_chat_id,'MoHaBoTs',tonumber(msg.date+86400),100,false)
if LinkGroup.code == 3 then
...
Redis:setex(itsEssen.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(itsEssen.."Essen:Status:Welcome"..msg_chat_id) then
...
Redis:del(itsEssen.."Essen:Welcome:Group"..msg_chat_id) 
...
Redis:setex(itsEssen.."Essen:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(itsEssen.."Essen:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(itsEssen.."Essen:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(itsEssen.."Essen:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(itsEssen.."Essen:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(itsEssen.."Essen:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(itsEssen.."Essen:Filter:Group:"..v..msg_chat_id)  
Redis:srem(itsEssen.."Essen:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(itsEssen.."Essen:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(itsEssen..'Essen:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(itsEssen..'Essen:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*˛ : ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(itsEssen.."Essen:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(itsEssen.."Essen:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(itsEssen.."Essen:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(itsEssen.."Essen:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(itsEssen.."Essen:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✅ ❭' else Statuslink = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✅ ❭' else StatusWelcome = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:Id"..msg.chat_id) then
StatusId = '❬ ✅ ❭' else StatusId = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✅ ❭' else StatusIdPhoto = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✅ ❭' else StatusReplySudo = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✅ ❭' else StatusBanId = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✅ ❭' else StatusSetId = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✅ ❭' else StatusGames = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✅ ❭' else Statuskickme = '❬ ❎❭'
end
if Redis:get(itsEssen.."Essen:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(itsEssen.."Essen:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(itsEssen.."Essen:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(itsEssen.."Essen:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(itsEssen.."Essen:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(itsEssen.."Essen:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(itsEssen.."Essen:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(itsEssen.."Essen:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(itsEssen.."Essen:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(itsEssen.."Essen:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(itsEssen..'Essen:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'˛ : تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(itsEssen..'Essen:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'˛ : تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(itsEssen..'Essen:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'˛ : تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'˛ : عدد رسائلك هنا *~ '..(Redis:get(itsEssen..'Essen:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'˛ : عدد التعديلات هنا *~ '..(Redis:get(itsEssen..'Essen:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'˛ : عدد جهاتك المضافه هنا *~ '..(Redis:get(itsEssen.."Essen:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(itsEssen.."Essen:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
...
Redis:del(itsEssen.."Essen:Set:Id:Groups")
...
Redis:setex(itsEssen.."Essen:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
...
Redis:del(itsEssen.."Essen:Set:Id:Group"..msg.chat_id)
...
Redis:del(itsEssen.."Essen:DevelopersQ:Groups") 
...
Redis:del(itsEssen.."Essen:Developers:Groups") 
...
Redis:del(itsEssen.."Essen:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:TheBasics:Group"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Originators:Group"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Managers:Group"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Addictive:Group"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:Distinguished:Group"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:BanAll:Groups") 
...
Redis:del(itsEssen.."Essen:BanGroup:Group"..msg_chat_id) 
...
Redis:del(itsEssen.."Essen:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(itsEssen.."Essen:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(itsEssen.."Essen:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(itsEssen.."Essen:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(itsEssen.."Essen:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(itsEssen.."Essen:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(itsEssen.."Essen:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ˛ : "
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(itsEssen.."Essen:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(itsEssen.."Essen:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(itsEssen.."Essen:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(itsEssen.."Essen:Add:Rd:Sudo:Gif"..v)   
Redis:del(itsEssen.."Essen:Add:Rd:Sudo:vico"..v)   
Redis:del(itsEssen.."Essen:Add:Rd:Sudo:stekr"..v)     
Redis:del(itsEssen.."Essen:Add:Rd:Sudo:Text"..v)   
Redis:del(itsEssen.."Essen:Add:Rd:Sudo:Photo"..v)
Redis:del(itsEssen.."Essen:Add:Rd:Sudo:Video"..v)
Redis:del(itsEssen.."Essen:Add:Rd:Sudo:File"..v)
Redis:del(itsEssen.."Essen:Add:Rd:Sudo:Audio"..v)
Redis:del(itsEssen.."Essen:Add:Rd:Sudo:video_note"..v)
Redis:del(itsEssen.."Essen:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Sudo:File"..v) then
db = "ملف ˛ : "
elseif Redis:get(itsEssen.."Essen:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(itsEssen.."Essen:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(itsEssen.."Essen:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(itsEssen.."Essen:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(itsEssen.."Essen:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
˛ : ارسل لي سواء كان 
❨ ملف ˛ : ملصق ˛ : متحركه ˛ : صوره
 ˛ : فيديو ˛ : بصمه الفيديو ˛ : بصمه ˛ : صوت ˛ : رساله ❩
...
Redis:setex(itsEssen.."Essen:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
˛ : ارسل لي سواء كان 
❨ ملف ˛ : ملصق ˛ : متحركه ˛ : صوره
 ˛ : فيديو ˛ : بصمه الفيديو ˛ : بصمه ˛ : صوت ˛ : رساله ❩
...
Redis:setex(itsEssen.."Essen:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
˛ : ارسل لي سواء كان 
❨ ملف ˛ : ملصق ˛ : متحركه ˛ : صوره
 ˛ : فيديو ˛ : بصمه الفيديو ˛ : بصمه ˛ : صوت ˛ : رساله ❩
...
Redis:setex(itsEssen.."Essen:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(itsEssen.."Essen:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(itsEssen..'Essen:GetTexting:DevitsEssen'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(itsEssen..'Essen:Texting:DevitsEssen')
...
Redis:setex(itsEssen.."Essen:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(itsEssen.."Essen:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"˛ : تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(itsEssen.."Essen:Name:Bot") or "باڤ") then
local NamesBot = (Redis:get(itsEssen.."Essen:Name:Bot") or "باڤ")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/teampav'}, 
},
{
...
if text == (Redis:get(itsEssen.."Essen:Name:Bot") or "آيلاند") then
local photo = LuaTele.getUserProfilePhotos(itsEssen)
local UserInfo = LuaTele.getUser(itsEssen)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
local NamesBot = (Redis:get(itsEssen.."Essen:Name:Bot") or "آيلاند")
local BotName = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
local BotName = {
"الحمد لله ونته",
"على قول @TttttX ع الباري ونتَ",
"انا بخير",
}
return LuaTele.sendText(msg_chat_id,msg_id,BotName[math.random(#BotName)],"md",true)   
end
if text == "بوسه" then
local NamesBot = (Redis:get(itsEssen.."Essen:Name:Bot") or "Essen")
local BotName = {
"اهممممواح🙈😉.",
"عيع خدك وصخ 😹🏃‍♀️.",
"اوفف اخدر اذاابوسه 🙈😻.",
...
x = x + 1
Redis:srem(itsEssen..'Essen:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,itsEssen)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*˛ : البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(itsEssen..'Essen:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(itsEssen..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(itsEssen..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(itsEssen..'Essen:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(itsEssen.."Essen:Game:Smile"..msg.chat_id,SM)
...
Redis:set(itsEssen.."Essen:Game:Monotonous"..msg.chat_id,name)
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(itsEssen.."mshaher"..msg.chat_id,name)
...
Redis:set(itsEssen.."Essen:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(itsEssen.."Essen:Status:Games"..msg.chat_id) then
Redis:del(itsEssen.."Essen:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(itsEssen.."Essen:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(itsEssen.."Essen:Status:Games"..msg.chat_id) then
Redis:del(itsEssen.."Set:Country"..msg.chat_id)
...
Redis:set(itsEssen.."Game:Countrygof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(itsEssen.."Essen:Status:Games"..msg.chat_id) then
Redis:del(itsEssen.."Essen:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(itsEssen.."Essen:Game:Reflection"..msg.chat_id,name)
...
Redis:set(itsEssen.."Essen:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(itsEssen.."Essen:Game:Difference"..msg.chat_id,name)
...
Redis:set(itsEssen.."Essen:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(itsEssen.."Essen:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(itsEssen.."Essen:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(itsEssen.."Essen:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثان','رفع مطور ثانوي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','مسح رسائلي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
Redis:sadd(itsEssen..'Essen:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(itsEssen.."Essen:Start:Bot") then
local CmdStart = '*\n˛ : اهلا بك عزيزي في بوت '..(Redis:get(itsEssen.."Essen:Name:Bot") or "باڤ")..
...
{
{text = '˛ : شࢪوحات السوࢪس -', url = 't.me/MoHaBoTs'},
},
{
{text = '˛ : سۅࢪس باڤ -', url = 't.me/teampav'},
},
}
}
...
{
{text = '˛ : شࢪوحات السوࢪس', url = 't.me/MoHaBoTs'}, {text = '˛ : شراء بوت', url = 't.me/TttttX'},
},
{
{text = '˛ : 𝗦ηαρ 𝗦??𝙪𝙧𝘤𝙚 ', url = 't.me/teampav'},
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(itsEssen.."Essen:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(itsEssen.."Essen:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(itsEssen.."Essen:Start:Bot") 
...
LuaTele.sendText(msg_chat_id,msg_id,'*˛ : عدد احصائيات البوت الكامله \n — — — — — — — — —\n˛ : عدد المجموعات : '..(Redis:scard(itsEssen..'Essen:ChekBotAdd') or 0)..'\n˛ : عدد المشتركين : '..(Redis:scard(itsEssen..'Essen:Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'الرتبه' or text == 'رتبته'  and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
...
if not msg.ControllerBot then
if Redis:get(itsEssen.."Essen:TwaslBot") and not Redis:sismember(itsEssen.."Essen:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(itsEssen.."Essen:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(itsEssen.."Essen:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(itsEssen..'Essen:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'˛ : تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(itsEssen..'Essen:BaN:In:Tuasl',Info_User)  
...
Redis:srem(itsEssen.."Essen:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(itsEssen..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(itsEssen.."Essen:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsEssen.."Essen:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(itsEssen.."Essen:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsEssen.."Essen:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(itsEssen.."Essen:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsEssen.."Essen:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(itsEssen.."Essen:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsEssen.."Essen:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(itsEssen.."Essen:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsEssen.."Essen:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(itsEssen.."Essen:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsEssen.."Essen:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(itsEssen.."Essen:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsEssen.."Essen:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(itsEssen.."Essen:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsEssen.."Essen:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(itsEssen.."Essen:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsEssen.."Essen:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(itsEssen.."Essen:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(itsEssen) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(itsEssen..'Essen:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Message_Edit.sender.user_id == itsEssen then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(itsEssen..'Essen:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(itsEssen.."Essen:Lock:edit"..data.chat_id) then
...
local Get_Chat = LuaTele.getChat(ChatId)
local GetLink = Redis:get(itsEssen.."Essen:Group:Link"..ChatId) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text = Get_Chat.title, url = LinkGroup.invite_link},},}}
return LuaTele.sendText(msg_chat_id, msg_id, " ◉ Link Group : \n["..Get_Chat.title.. ']('..LinkGroup.invite_link..')', 'md', true, false, false, false, reply_markup)
...
io.popen("curl -s 'http://185.185.127.158/Essen/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=ogg&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/Essen/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp3&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/Essen/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp4&msg=0'")
end
end
...
keyboard.inline_keyboard = {
{
{text = '❲ S𝘰𝘶𝘳𝘤𝘦 S𝘯𝘢𝘱 ❳',url="https://t.me/teampav"},{text = ' Updates source ⁦ᯓ',url="https://t.me/MoHaBoTs"}
},
{
{text = '  S𝘯𝘢𝘱 ⁦ᯓ',url="https://t.me/TttttX"}
},
}
local msg_id = Msg_id/2097152/0.5
...
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*˛ :  ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(itsEssen.."Essen:zhrfa"..IdUser,"sendzh") 
end 
...
Redis:set(itsEssen.."Essen:rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(itsEssen.."Essen:AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:AddSudosNew"..ChatId)
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/shaarEssen/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'ش','شعر')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'را','راب')
Redis:set(itsEssen.."Essen:Get:Reides:Commands:Group"..UserId[2]..":"..'ري','ريمكس')
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(itsEssen.."Essen:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(itsEssen.."Essen:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(itsEssen.."Essen:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(itsEssen.."Essen1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(itsEssen.."Essen:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(itsEssen.."Essen:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(itsEssen.."Essen:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(itsEssen.."Essen1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(itsEssen.."Essen:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"˛ : ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(itsEssen.."Essen:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"˛ : ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(itsEssen.."Essen:Num:Add:Games"..ChatId..IdUser, 1)  
...
local TextHelp = [[*
˛ : أهلا بك في قائمة العاب سورس باڤ اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
˛ : مرحبا بك في الالعاب المتطورة الخاص بسورس باڤ 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(itsEssen.."Essen:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(itsEssen.."Essen:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(itsEssen.."Essen:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(itsEssen.."Essen:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(itsEssen.."Essen:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(itsEssen.."Essen:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(itsEssen.."Essen:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(itsEssen.."Essen:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(itsEssen..'Essen:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(itsEssen.."Essen:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '• رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"˛ : تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsEssen.."Essen:SilentGroup:Group"..ChatId) 
